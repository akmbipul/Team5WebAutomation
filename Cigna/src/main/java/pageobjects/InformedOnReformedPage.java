...
public class InformedOnReformedPage extends CommonAPI {
    @FindBy(css="#\\31 386145320485 > div > div.global-header-legacy > header > div > nav > div > ul > li.nav-item.active > a")
    ...
    public void setInformedOnReformed(){
        informedOnReformed.click();
    }
